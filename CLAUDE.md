...
- [ ] Fase 2 (prossimi): slider continuo diretto↔divertente (via `custom_model` nel body POST /route sopra profilo base — verificare merge semantics), import GPX, auth/multi-utente (→ PostGIS)
