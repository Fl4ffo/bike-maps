...
- [ ] Fase 2 (prossimi): slider continuo diretto↔divertente (via `custom_model` nel body POST /route sopra profilo base — verificare merge semantics), import GPX, POI lungo il percorso (passi, viewpoint, benzinai), auth/multi-utente (→ PostGIS)
